...
function initNagishLi() {
  ...
  positions = {
    TR: "top: 0vh; left: 0 !important;",
    TL: "top: 0vh; left: 0 !important;",
    BR: "top: 0vh; left: 0 !important;",
    BL: "top: 0vh; left: 0 !important;",
  };
  commons = {
  ...
  $NagishLi(function (a) {
    ...
    e +=
      "* nagishli#NagishLiTag * {font-size: 18px !important; line-height: " +
      (G ? "2.5vh" : "1.15") +
    ...
    e +=
      commons.menus +
      " { list-style: none !important; display: none; padding: 0 !important; margin: 0 !important; width: 100% !important; position: relative; top: -3vh; min-width: 345px !important; max-height: " +
      (a(window).height() - 41) +
    ...
    e +=
      commons.bar +
      " > #NagishLiBarStrip {display: block; color: #ffffff !important; cursor: pointer !important; padding: 10px !important; background: #000000ff;background-image: url(`../assets/images/accessibility.svg`) !important; background-repeat: no-repeat; background-size: 100% 100%; background-position: center; width: 6vw; height: 6vh;}";
        ...
        (1 !== b.which && 13 !== b.which) ||
          ...
          (a(commons.menus).is(":visible")
            ? (a(commons.menus).slideUp(150, function () {
              ...
              (c = "closed"))
            : (a(this).addClass("").next("#NagishLiMenus").slideDown(150)),
          f("change", "menu", c));
      }
    );
